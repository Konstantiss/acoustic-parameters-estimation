...
model.load_state_dict(torch.load(RESULTS_DIR + 'vgg-save-2023-11-23 004648.883451-30.bin'))
...
results_filename = RESULTS_DIR + 'results-vgg-per-utterance-' + date_time + '-' + str(EPOCHS) + '.pkl'
