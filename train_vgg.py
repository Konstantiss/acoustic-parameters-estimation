...
model_save_filename = 'vgg-save' + date_time + '-' + str(EPOCHS) + '.bin'
...
results_filename = 'results-vgg-' + date_time + '-' + str(EPOCHS) + '.pkl'
with open(results_filename, 'wb') as handle:
    pickle.dump(results, handle, protocol=pickle.HIGHEST_PROTOCOL)

plot_filename = 'figs/vgg-loss-plot-train-' + date_time + '-' + str(EPOCHS) + '.png'
...
plot_filename = 'figs/vgg-loss-plot-eval-' + date_time + '-' + str(EPOCHS) + '.png'
plt.figure(figsize=(10, 5))
