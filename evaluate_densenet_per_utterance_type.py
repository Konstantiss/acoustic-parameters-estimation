...
model.load_state_dict(torch.load(RESULTS_DIR + 'densenet-save-2023-11-23 084819.517556-30.bin'))
...
results_filename = RESULTS_DIR + 'results-densenet-per-utterance-' + date_time + '.pkl'
