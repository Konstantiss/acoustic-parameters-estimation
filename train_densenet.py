...
plot_filename = RESULTS_DIR + 'figs/densenet-loss-plot-train-' + date_time + '-' + str(EPOCHS) + '.png'
plt.figure(figsize=(10, 5))
plt.title("DenseNet121 DRR and RT60 training loss per epoch")
...
# plot_filename = RESULTS_DIR + 'figs/densenet-loss-plot-eval-' + date_time + '-' + str(EPOCHS) + '.png'
# plt.figure(figsize=(10, 5))
# plt.title("DenseNet121 DRR and RT60 evaluation loss per epoch")
